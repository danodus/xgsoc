...
void main(void)
{
    ...
    for (;;) {
        ...
        draw_model(FB_WIDTH, FB_HEIGHT, &vec_camera, cube_model, &mat_world, &mat_proj, &mat_view, is_lighting_ena, is_wireframe, is_textured ? &dummy_texture : NULL, false, false);
