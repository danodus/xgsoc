                               ...
                               bool clamp_s, bool clamp_t)
{
    ...
    c.opcode = OP_DRAW;
    c.param = (clamp_s ? 0b1000 : 0b0000) | (clamp_t ? 0b0100 : 0b0000) | ((tex != NULL) ? 0b0010 : 0b0000) | 0b0001;
    send_command(&c);
}
...
void main(void)
{
    ...
    for (;;) {
        ...
        draw_model(128, 128, &vec_camera, cube_model, &mat_world, &mat_proj, &mat_view, true, false, NULL, false, false);
